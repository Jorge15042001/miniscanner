...
// configuration step. It creates a namespace called `miniscanner`. You can modify
...
{
  try {
    CLI::App app{ fmt::format("{} version {}", miniscanner::cmake::project_name, miniscanner::cmake::project_version) };
    ...
    if (show_version) {
      fmt::print("{}\n", miniscanner::cmake::project_version);
      return EXIT_SUCCESS;
    }
